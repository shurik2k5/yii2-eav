...
insert  into `eav_attribute`(`id`,`entityId`,`typeId`,`name`,`label`,`defaultValue`,`defaultOptionId`,`required`) values (6,1,3,'test','Тест','0',7,0),(7,1,1,'test1','EAV поле','0',3,0),(8,1,2,'test2','EAV поле 2','0',3,0),(9,1,6,'test3','EAV поле 3','0',3,0),(10,1,5,'test4','EAV поле 4','0',3,0),(11,1,4,'test5','EAV поле 5','0',3,0);
...
insert  into `eav_attribute_type`(`id`,`name`,`handlerClass`,`storeType`) values (1,'raw','\\mirocow\\eav\\widgets\\TextInput',0),(2,'option','\\mirocow\\eav\\widgets\\DropDownList',1),(3,'multiple','\\mirocow\\eav\\widgets\\CheckBoxList',2),(4,'array','\\mirocow\\eav\\widgets\\EncodedTextInput',3),(5,'radio','\\mirocow\\eav\\widgets\\RadioList',3),(6,'area','\\mirocow\\eav\\widgets\\Textarea',0);
...
insert  into `eav_attribute_value`(`id`,`entityId`,`attributeId`,`value`,`optionId`) values (28,16,6,NULL,3),(30,16,7,'Текстовое поле Текстовое поле 2',NULL),(31,16,8,NULL,6),(32,16,9,'Текстовое поле Текстовое поле Текстовое поле Текстовое поле Текстовое поле Текстовое поле Текстовое поле Текстовое поле Текстовое поле Текстовое поле 2',NULL),(33,16,10,NULL,9),(35,16,6,NULL,4);
...
insert  into `eav_entity`(`id`,`entityName`,`entityModel`) values (1,'Продукт','common\\models\\Product');
